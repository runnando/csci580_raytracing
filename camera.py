...
class Camera:
    ...
    def get_ray(self, n):
        # in each pixel, take a random position offset +-0.5 to avoid aliasing.
        ...
        return Ray(origin=ray_origin, dir=ray_dir, depth=0, n=n, reflection_depth=0, refraction_depth=0,
                   diffuse_reflection_depth=0)
